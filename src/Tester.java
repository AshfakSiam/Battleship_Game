...
public class Tester extends JFrame {
	...
	/**
	 * This method is called to start the video game which then calls the infinite
	...
	/**
	 * Method contains the game loop to move enemies, manage score, and check if the
	 * game is finished.
	 */
	...
	/**
	 * Pauses the thread for 30ms to control the speed of the animations.
	 */
	...
	/**
	 * Randomly assign a value to determine how soon a new Enemy should be created.
	 */
